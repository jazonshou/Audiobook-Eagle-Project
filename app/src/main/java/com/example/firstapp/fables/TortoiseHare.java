...
public class TortoiseHare {
    ...
    public static final String M_BODY =
            "    野兔曾經在其他動物面前吹噓自己的速度。 他說，“當我全力以赴的時候，我從來沒有被打敗過，你們" +
                    "誰要跟我比？”\n" +
                    "\n" +
                    "    烏龜平靜地說：“我接受你的挑戰。”\n" +
                    "\n" +
                    "    “真是個笑話，我跳舞都比你快。”野兔說。\n" +
                    "\n" +
                    "    “繼續吹牛吧，直到我把你打敗，我們現在開始嗎？” 烏龜回答說。\n" +
                    "\n" +
                    "    他們確定了路線就開始了。 野兔幾乎立刻跑到看不見的地方，但很快就停了下來，他覺得" +
                    "烏龜不可能贏過他，躺下小睡了一會兒。 烏龜緩慢而堅定地向前行，當兔子醒來時，他看到" +
                    "烏龜早已快到終點了，即使用力跑也贏不了這場比賽了。於是烏龜說，”堅持到最後的就能成功。”";
}
